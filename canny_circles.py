...
frame_v = cv2.applyColorMap(cv2.imread('img1.jpg', 0), cv2.COLORMAP_HSV)
...
circles = cv2.HoughCircles(cimg, cv2.cv.CV_HOUGH_GRADIENT, 1, 125,
                           param1=10, param2=30, minRadius=0, maxRadius=100)
